...
- Agents:
  ...
  - Time Perception: estimate correction, countdown, transition helper, hyperfocus detection.
...
## Limitations
- Some tools return configuration payloads; timers and A2A flows are stubs to be expanded.